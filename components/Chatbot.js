  ...
  const sendMessage = async () => {
    ...
    try {
      const response = await fetch("/api/chatbot", {
        ...
        body: JSON.stringify({
          message: `You are an AI assistant specializing in Social Good, Human Experience, Environment, and Sustainability. please provide a detailed, structured response: "${userInput}". Do not include "*" symbols and make it short and just give me a simple paragraph or two. If the user asks about other people’s items, provide them with that info`,
        }),
      });
